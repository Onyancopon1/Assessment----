...
# Create a string with the names and stats of all the monsters
monster_str = ""
for monster in monsters:
    monster_str += f"{monster['name']} - Strength: {monster['Strength']}, Speed: {monster['Speed']}, Stealth: {monster['Stealth']}, Cunning: {monster['Cunning']}\n"

# Display the list of monsters in a messagebox
easygui.msgbox(msg=monster_str, title="List of Monsters")
