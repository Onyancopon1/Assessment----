...
while True:
    ...
    if choice == 'Add Monster':
        ...
        remove_choice = easygui.buttonbox('How do you want to remove a monster?', 'Remove Monster',
                                          ('By Name', 'By Index', 'Cancel'))

        if remove_choice == 'By Name':

            monster_names = [monster['name'] for monster in monsters]

            monster_to_remove = easygui.choicebox("Which monster do you want to remove?", "Remove Monster",
                                                  monster_names)
            ...
            index_choice = easygui.integerbox('Enter the index of the monster you want to remove:', 'Remove Monster',
                                              lowerbound=0, upperbound=len(monsters) - 1)
